...
<body>
	...
	<form name='frm' method='POST' action='./update'
		...
		<input name="old_photo" value="${dto.photo }" type="hidden"> <input
			name="old_bgphoto" value="${dto.bgphoto }" type="hidden">
		<table>
			<tr>
				<th><img id="bgphoto_size" alt="loding..."
					src="../member/${dto.bgphoto }"></th>
			...
			<tr>
				...
				<td><input type="checkbox" name="inter" value="인물"
					...
					<c:if test="${fn:indexOf(dto.interests,'동물')!=-1}">checked</c:if>>동물
					<input type="checkbox" name="inter" value="자연"
