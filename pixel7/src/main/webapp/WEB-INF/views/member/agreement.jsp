...
<body leftmargin="0" topmargin="0">
 ...
 -->
	<form name="frm" method="get" action="./create"
		...
		<table border="0" cellspacing="0" cellpadding="2" align="center">
			<tr>
				<td align="center"><textarea cols="100" rows="20" disabled>Cummunity 서비스약관 (2005. 7. 18 부터 유효) 
...
본 약관은 2005. 7. 18. 부터 적용하고, 2004. 10. 11.부터 적용되던 종전의 약관은 본 약관으로 대체합니다.  
		...
		<div style="text-align: center">
			<label for="agreement"><input id="agreement" type="checkbox"
				name="agree" value="1"> 약관에 동의합니다</input></label> <input type="submit"
				value="회원가입"></input> <input type="button" value="취소"
